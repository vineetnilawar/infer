...
C++, Objective-C, and C.If you give Infer some Java or C/C++/Objective-C code it produces a list of potential bugs.Infer is written in [OCaml](https://ocaml.org/).
